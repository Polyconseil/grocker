...
.. code-block:: bash
    ...
    $ grocker --runtime {python, python3} --entry-point {grocker-pyapp, grocker-bluedjango} build {project}=={version}
    $ # par exemple pour créer une image de dev de milborne :
    $ python -m grocker --runtime python --entry-point grocker-bluedjango build milborne==0.4.0.dev2015041600283
